...
import { Eye, TrendingUp, Activity, Loader, Brain } from 'lucide-react';
...
export const DetectionPanel = ({
  ...
  const getStatusText = () => {
    if (!isInitialized) return 'Loading Model...';
        ...
        {recentSigns.length === 0 && (
          <div className="empty-state">
            ...
            <p className="empty-title">
              {!isInitialized ? 'Loading Custom Model...' : 'No signs detected yet'}
            </p>
