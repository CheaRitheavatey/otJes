...
import { Brain, CheckCircle, AlertCircle, RefreshCw, Folder } from 'lucide-react';
      ...
      <div className="api-key-content">
          ...
          {isInitialized && modelInfo ? (
            <div className="model-info">
              ...
              <div className="model-details">
                ...
                <p><strong>Classes:</strong> {modelInfo.classLabels?.length || 0} signs detected</p>
                {modelInfo.classLabels && (
                  <div className="class-labels">
                    <p><strong>Detectable Signs:</strong></p>
                    <div className="labels-grid">
                      {modelInfo.classLabels.map((label, index) => (
        ...
        <div className="api-info">
          ...
          <ul>
            ...
            <li><strong>Detection:</strong> Real-time processing every 1 second</li>
          </ul>
        </div>
      </div>
    </div>
